...
<html lang="pt-BR">
  <head>
    ...
    <body>
        ...
        <section class="dashbord-info">
            <div class="navigation">
                <nav class="navbar bg-body-tertiary">
                    <ul  class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li  class="nav-item">
                            <a class="nav-link" href="?page=salas">Salas</a>
                        </li>

                        <li  class="nav-item">
                            <a class="nav-link" href="?page=eventos">Eventos</a>
                        </li>

                        <li  class="nav-item">
                            <a class="nav-link" href="?page=responsaveis">Responsaveis</a>
                        </li>
                        ...
                        <li  class="nav-item">
                            <a class="nav-link" href="?page=participantes">Participantes</a>
                        </li>
                    </ul>
                </nav>
            </div>
