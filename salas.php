         ...
         <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="exampleModalLabel">Cadastre uma nova sala</h1>
                        ...
                        <div class="modal-body">
                            <form action="?page=salvar_sala" method="POST">
                                ...
                                <div class="mb-3">
                                    <label for="">Capacidade_maxima</label>
                                    <input type="text" class="form-control" name="capacidade_maxima">
                                </div>

                                <div class="mb-3">
                                    <label for="">Recurso Disponível</label>
                    ...
                    <table class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            <tr>
                                <td>Nome Exemplo</td>
                                <td>Capacidade Exemplo</td>
                                <td>Recursos Exemplo</td>
                                <td>Data Exemplo</td>
                                <td>
